...
if "bpy" in locals():
    ...
    importlib.reload(remove_aabb_shape_collider)
else:
    ...
    from . import remove_aabb_shape_collider
import bpy
...
def register():
    ...
    bpy.utils.register_class(remove_aabb_shape_collider.RemoveAABBBlockCollider)
...
def unregister():
    ...
    bpy.utils.unregister_class(remove_aabb_shape_collider.RemoveAABBBlockCollider)